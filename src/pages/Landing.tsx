  ...
  return (
    <Layout>
      <section className="flex flex-col items-center justify-center px-6 pt-12 pb-16 md:pt-20 md:pb-24 lg:pt-24 lg:pb-28 text-center max-w-[1150px] mx-auto min-h-[70vh] md:min-h-[65vh]">
        ...
        <p 
          className={`mt-8 md:mt-10 text-lg md:text-xl text-muted-foreground max-w-md leading-relaxed transition-opacity duration-800 ${
            headlineComplete ? "animate-fade-in-opacity" : "opacity-40"
          }`}
        >
