...
export const shareViaWhatsApp = ({
  ...
  return new Promise((resolve) => {
    try {
      ...
      // Use app link on mobile, web version otherwise (unless explicitly requested)
      const baseUrl = (isMobile && !useWebVersion)
        ? 'whatsapp://send' 
        : useWebVersion
        ? 'https://web.whatsapp.com/send' 
        : 'https://wa.me';
      
      const whatsappUrl = `${baseUrl}?text=${encodeURIComponent(cleanMessage)}`;
